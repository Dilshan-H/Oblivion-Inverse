from flask import render_template, redirect, url_for, flash, get_flashed_messages, send_file, request, abort
...
def index():
    ...
    if form.validate_on_submit():
        ...
        trackingData = TrackData(utmId=str(utm_id), emailTitle=form.email_title.data, generatedDate=generatedOn)
...
def tracklist():
    ...
    if q:
        trackingList= TrackData.query.filter(TrackData. emailTitle.contains(q) | TrackData. generatedDate.contains(q))
    else:
