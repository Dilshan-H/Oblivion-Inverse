...
## 🔴 NOTE: This is the readme file for the **`V1`** branch. This branch contains the source code for the **first version of the project**. If you're looking for the latest version, please visit the [main](https://github.com/Dilshan-H/Oblivion-Inverse) branch.

### ⚠️ WARNING: This version is no longer actively maintained. We are moving onto **Render, Firebase** platforms with the latest version of the project. This version is suitable for those who are willing to deploy on **Heroku** platform or willing to host on their own server with SQL database.
